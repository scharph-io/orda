...
func (s *Server) SetupRoutes(app *fiber.App) {
	...
	account.Post("/deposit", s.accountHandlers.DepositMany, s.authHandlers.RequireRole("admin"))
	...
	stats.Get("/paymentoptions", s.statisticsHandlers.GetPaymentOptionsForDateRange)
}
