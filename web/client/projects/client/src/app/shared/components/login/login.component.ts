...
@Component({
  ...
  template: `
    <mat-card class="max-w-5xl mx-auto px-4 py-4 space-y-4">
      <mat-card-header>
        <h2 class="text-3xl font-semibold">Welcome to orda</h2>
      </mat-card-header>
      <mat-card-content>
        <form [formGroup]="loginForm" (submit)="onSubmit()" class="container">
